...
export const removeStakeholderInformationElementRelation = formData => async dispatch => {
    const config = {
        headers: {
            "Content-Type": "application/json"
        }
...
export const removeStakeholderInformationElementRelationFromRedux = (type, id) => async dispatch => {
    dispatch({
